"""
streamlit_app.py  -  Web front-end for the ZapGT-1 V2 geothermal techno-economic model.
...
import geothermal_HE_ZapV2 as GHE
from main_zapv2 import build_commingled, CALIBRATED_CONFIG as RES_CFG
import esp_geothermal_ZapV2 as ESPMOD

st.set_page_config(page_title="Geothermal Techno-Economic Model — ZapGT-1 V2", layout="wide")
st.title("Geothermal Techno-Economic Model — ZapGT-1 V2")
...
with tab_res:
    ...
    try:
        ...
        viz = doublet_viz.visualize_doublet(dict(h=_mp["h"], k=_mp["k"], name=_mp.get("name", "reservoir")),
              ...
              phi_doublet=_mp["phi"], well_name="ZapGT-1 V2", save_dir=tmp)
