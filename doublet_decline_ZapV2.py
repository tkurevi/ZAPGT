...
if __name__ == "__main__":
    # ZapGT-1 V2 layer (from get_v3_results) - quick self-test
    layers = [dict(h=161.0, phi=0.10, k=9128.92, T0=86.7)]
    t, T = doublet_temperature_decline(93.75, 1400.0, 40.0, layers, years=30)
    print("year   T_prod(C)")
